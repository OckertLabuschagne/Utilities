...
namespace SEFI.UserControls
{
    public partial class UserInputControl : UserControl
    {
            ...
            else
            {
                switch (_InputType)
                {
                    ...
                    case InputType.Date:
                        ...
                        {
                            Dock = DockStyle.Fill,
                            MaxDate = _Value is DateTime ? (DateTime) _Value : DateTime.Now
                        };
                        dateTime.BringToFront();
        ...
        {
            _Value = (sender as DateTimePicker).Value;
            OnValueChanged(e);
        }
        ...
        public void SetValue(object value)
        {
            ...
            switch (_InputType)
            {
                ...
                case InputType.Image:
                    ...
                    break;
                case InputType.Date:
                    (_EditorControl as DateTimePicker).MaxDate = DateTime.Now;
                    (_EditorControl as DateTimePicker).Value = (DateTime)value;
                    break;
            }
        }
        ...
        public DateTime GetDate()
        {
            if (_Value is DateTime)
                ...
                throw new InvalidCastException($"{_Value} is not a date value");
        }
