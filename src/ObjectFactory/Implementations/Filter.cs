...
namespace SEFI.Classes
{
    public class Filter : IFilter
    {
        ...
        public IFilter HasName(string name) { Name = name; return this; }
        public IFilter HasPropertyName(string propertyName) { PropertyName = propertyName; return this; }
        public IFilter HasFieldName(string fieldName) { FieldName = fieldName; return this; }
        public IFilter HasOperator(ComparisonOperator oper) { Operator = oper; return this; }
        public IFilter HasValue(IValueObject value) { Value = value; return this; }
		...
		public virtual Expression<Func<T, bool>> GetExpression<T>( bool databaseField = true)
        {
            ParameterExpression param = Expression.Parameter(typeof(T), "x");
            Expression expression = GetExpression(param, databaseField? null : PropertyName?? Name);
